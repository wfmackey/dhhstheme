...
Additional contributors or maintainers are **more than welcome**.
...
This process works for all kinds of plot `geoms`, and colour arguments to `dhhs_theme` will flow through to `geom` default colours (for lines or point or whatever). Examples below.
