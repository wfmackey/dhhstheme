...
dhhs_y_continuous <- function(expand_bottom = 0, expand_top = 0.015, ...) {
...
scale_y_continuous_dhhs <- function(expand_bottom = 0,
                                       expand_top = 0.015,
                                       ...) {

  dhhs_y_continuous(expand_bottom = expand_bottom,
...
dhhs_x_continuous <- function(expand_left = 0,
                                 expand_right = 0.015,
                                 ...) {
...
scale_x_continuous_dhhs <- function(expand_left = 0,
                                       expand_right = 0.015,
                                       ...) {

  dhhs_x_continuous(expand_left = expand_left,
